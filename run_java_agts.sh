...
echo "SCRIPT: USAGE: ./run_java_agts.sh <worldfile> <num rounds> <# agents> <classpath> <agent executable> <protocol filename> <output filename>"
echo "SCRIPT: EXAMPLE: ./run_java_agts.sh ExampleWorld.world 100 7 Ares-System.jar Agent.ExampleAgent.Main replay.txt output.txt"
